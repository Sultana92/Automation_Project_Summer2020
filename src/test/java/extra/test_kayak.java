...
public class test_kayak {
        ...
        public void kayak_actionItem() throws InterruptedException, WriteException {
            ...
            for (int i = 1; i < rows; i++) {
                ...
                Reusable_Methods.click(driver, "//*[text()='Enter an airport or city']", "Search fField");

                Thread.sleep(2000);

                //enter the airport
                Reusable_Methods.sendKeys(driver, "//*[@name='pickup']", airPort, "Search Field");

                //click on the designated airport
                Reusable_Methods.click(driver, "//*[@class='ap-code']", "airport");

                Thread.sleep(2000);

                //click on end date
                Reusable_Methods.click(driver, "//*[@class='_itL js-end-input']", "end date");
                ...
                //click on end time
                Reusable_Methods.clickByIndex(driver, "//*[@aria-haspopup='listbox']", 2, "endTime");

                Thread.sleep(2000);
                //enter end time
                Reusable_Methods.clickByIndex(driver, "//li[@aria-label='" + endTime + "']", 1, "End Time");

                Thread.sleep(2000);

                //click on start date
                Reusable_Methods.clickByIndex(driver, "//*[@class='_isu _iad _iaf _iEc _iaa _iPK _iam _j0E _j0F _iai']", 0, "startDate");

                Thread.sleep(1000);
                //enter start date
                Reusable_Methods.typeAndSubmit(driver, "//div[contains(@id,'pickup-date-input')]", startDate, "start date");
                ...
                //enter start time
                Reusable_Methods.clickByIndex(driver, "//li[@aria-label='" + startTime + "']", 0, "start time");
                ...
                //click on search
                Reusable_Methods.click(driver, "//*[@class='_h-2 _ivP _iv1']", "search");

                Thread.sleep(4000);

                //select vehicle size
                Reusable_Methods.clickByIndex(driver, "//div[contains(@id,'" + vehicleSize + "')]", 1, "vehicle size");

                Thread.sleep(4000);

                //click on second index for View Deal
                Reusable_Methods.clickByIndex(driver, "//*[text()='View Deal']", 2, "view Deal");
                ...
                String info = Reusable_Methods.captureText(driver, "//*[@class='rental-info', or @class='Checkout-Car-Book-Main-CarSummary', or @class='booking-section']", "Results");
